  ...
  return (
    <div className="working__process__container">
      ...
      <div className="working">
        ...
        <div className="working__process">
          <img src="/src/assets/Fried-Chicken.png" alt="" className="for__mob" />
          <h4>
            <div className="circle"></div>
          ...
          <img src="/src/assets/Fried-Chicken.png" alt="" className="for__web" />
        </div>
        <div className="working__process">
          <img src="/src/assets/packes.png" alt="" />
          <h4>
            <div className="circle"></div>
            <span>DELIVER</span>
          </h4>
